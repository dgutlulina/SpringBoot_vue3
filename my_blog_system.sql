...
CREATE TABLE `t_article`  (
                              ...
                              CONSTRAINT `fk_article_author_id` FOREIGN KEY (`author_id`) REFERENCES `t_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `t_comment`  (
                              ...
                              CONSTRAINT `fk_comment_article_id` FOREIGN KEY (`article_id`) REFERENCES `t_article` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `t_comment` VALUES (15, 1, '2025-10-22', NULL, '111', 'approved', '李四');
INSERT INTO `t_comment` VALUES (16, 1, '2025-10-30', NULL, '555', 'approved', '匿名用户');
INSERT INTO `t_comment` VALUES (17, 30, '2025-10-30', NULL, '好可爱', 'approved', '李四');
INSERT INTO `t_comment` VALUES (18, 30, '2025-10-30', NULL, '888888', 'approved', '李四');
INSERT INTO `t_comment` VALUES (19, 53, '2025-12-19', NULL, '23232', 'approved', '李四');
INSERT INTO `t_comment` VALUES (20, 12, '2025-12-19', NULL, '321321', 'approved', '李四');
...
CREATE TABLE `t_favorite`  (
                               ...
                               CONSTRAINT `fk_favorite_article_id` FOREIGN KEY (`article_id`) REFERENCES `t_article` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                               CONSTRAINT `fk_favorite_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `t_like`  (
                           ...
                           INDEX `idx_article_id`(`article_id` ASC) USING BTREE,
                           INDEX `idx_created_at`(`created_at` ASC) USING BTREE,
                           CONSTRAINT `fk_like_article_id` FOREIGN KEY (`article_id`) REFERENCES `t_article` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                           CONSTRAINT `fk_like_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_statistic`  (
                                ...
                                `heart_count` int NOT NULL DEFAULT 0 COMMENT '点赞数',
                                PRIMARY KEY (`id`) USING BTREE,
                                UNIQUE INDEX `idx_article_id`(`article_id` ASC) USING BTREE,
                                CONSTRAINT `fk_statistic_article_id` FOREIGN KEY (`article_id`) REFERENCES `t_article` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_statistic
-- ----------------------------
INSERT INTO `t_statistic` VALUES (1, 1, 91, 5, 0);
INSERT INTO `t_statistic` VALUES (2, 2, 3, 0, 0);
INSERT INTO `t_statistic` VALUES (3, 3, 4, 0, 0);
INSERT INTO `t_statistic` VALUES (4, 4, 4, 0, 0);
INSERT INTO `t_statistic` VALUES (5, 5, 4, 0, 0);
INSERT INTO `t_statistic` VALUES (6, 6, 15, 0, 0);
INSERT INTO `t_statistic` VALUES (7, 7, 6, 0, 0);
INSERT INTO `t_statistic` VALUES (8, 8, 23, 1, 0);
INSERT INTO `t_statistic` VALUES (9, 9, 18, 0, 0);
INSERT INTO `t_statistic` VALUES (10, 10, 18, 1, 0);
INSERT INTO `t_statistic` VALUES (11, 11, 10, 1, 0);
INSERT INTO `t_statistic` VALUES (12, 12, 39, 1, 0);
...
CREATE TABLE `t_user`  (
                           ...
                           `avatar` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像URL',
                           `created` datetime NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'admin', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '2127269781@qq.com', '系统管理员，负责维护博客系统', '/api/images/avatars/b0d5e4b3-b4c5-4692-8378-6cc5c22e5531.jpg', '2018-10-01 00:00:00', '2026-01-01 22:21:56', 1);
INSERT INTO `t_user` VALUES (2, '李四', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '1768653040@qq.com', 'Java开发工程师，热爱技术分享', '/api/avatars/lisi.png', '2018-11-13 00:00:00', '2018-11-13 00:00:00', 1);
INSERT INTO `t_user` VALUES (3, '东方不败', '$2a$10$5ooQI8dir8jv0/gCa1Six.GpzAdIPf6pMqdminZ/3ijYzivCyPlfK', '13718391550@163.com', '前端技术爱好者，专注移动端开发', '/api/avatars/dongfang.png', '2018-12-18 00:00:00', '2018-12-18 00:00:00', 1);
...
CREATE TABLE `t_user_authority`  (
                                     ...
                                     CONSTRAINT `fk_user_authority_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                                     CONSTRAINT `fk_user_authority_authority_id` FOREIGN KEY (`authority_id`) REFERENCES `t_authority` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
